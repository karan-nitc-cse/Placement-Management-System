...
<body class="hold-transition skin-green sidebar-mini">
  ...
  <div class="wrapper">
  <div class=" content-wrapper" style="margin-left: 0px; background: #161A30">
<!--
<section class="content-header">
  <div class="container" style="background:#435585 ">
    <div class="row latest-job margin-top-50  margin-bottom-20" style=" background:#B6BBC4">
      ...
      <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
        <div class="col-md-6 latest-job ">
          ...
          <div class="form-group">
            <input class="form-control input-lg" type="text" id="stream" name="stream" placeholder="Branch">
          </div>
          <div class="form-group checkbox">
            <label><input type="checkbox"><strong> I accept terms &amp; conditions</strong></label>
          </div>
          <div class="form-group">
          ...
          <div class="row latest-job margin-top-50 margin-bottom-20" style="background: #B6BBC4">
            ...
            <form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data">
              ...
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="text" id="cgpa" name="cgpa" placeholder="cgpa">
                </div>
