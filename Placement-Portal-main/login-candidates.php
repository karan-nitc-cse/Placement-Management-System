...
<body class="hold-transition login-page bg-blue-100 text-white">
  ...
  <div class="login-box hello">
    ...
    <!-- /.login-logo -->
    <div class="login-box-body bg-black text-black ">
      ...
      ?>
        <div>
          <p id="successMessage" class="text-center" style="color: white;">You Have Registered Successfully! Your Account Approval Is Pending By Placement-Officer</p>
        </div>
      <?php
      ...
      ?>
        <div>
          <p class="text-center" style="color: white;">Invalid Email/Password! Try Again!</p>
        </div>
      <?php
      ...
      ?>
        <div>
          <p class="text-center" style="color: white;">Your Account Is Active. You Can Login</p>
        </div>
      <?php
