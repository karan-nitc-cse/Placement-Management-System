...
<body class="hold-transition login-page bg-blue-100 text-white">
  ...
  <div class="login-box content:centre">
    ...
    <!-- /.login-logo -->
    <div class=" login-box-body bg-black text-black text-xl">
      <p class="text-white text-2xl login-box-msg text-white">Company Login</p>
      ...
      <form method="post" action="checkcompanylogin.php">
        ...
        <div class="row">
          ...
          <div class=" col-xs-12">
              ...
              ?>
                <div>
                  <p class="text-center" style="color: white;">You Have Registered Successfully! Your Account Approval Is Pending By Placement-Officer</p>
                </div>
              <?php
